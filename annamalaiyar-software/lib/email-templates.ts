...
export function quoteEmail(serviceName: string, price: number, description: string, deliveryTime: string, quoteId: string) {
  ...
  <head>
    ...
    <style>
      ...
      .label { color:#D4AF37; font-weight:bold; }
      .track-link { display:inline-block; margin-top:20px; padding:12px 24px; background-color:#D4AF37; color:#0B0B0B; text-decoration:none; font-weight:bold; border-radius:6px; }
      .footer { padding:16px; text-align:center; color:#888888; font-size:12px; border-top:1px solid #333; }
    </style>
  </head>
  <body>

        ...
        {step === "password" ? (
          <>
            ...
            <div className="relative mb-4">
              <input
                ...
                className="w-full p-3 bg-white/10 rounded pr-10"
              />
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)}
                className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gold-400"
              >
          ...
          <>
            ...
            <button
              ...
              className="text-sm text-gold-400 mt-2 block"
            >
              Back to login
            </button>
          </>
